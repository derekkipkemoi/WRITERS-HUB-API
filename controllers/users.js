...
module.exports = {
  ...
  addProfessionalSummary: async (req, res) => {
    ...
    try {
      ...
      res
        .status(200)
        .json({
          message: "Professional summary added successfully.",
      ...
      res
        .status(500)
        .json({
          message: "An error occurred while adding professional summary",
          error: error.message,
        });
    }
  },
  ...
  addSkills: async (req, res) => {
    ...
    try {
      ...
      res
        .status(200)
        .json({ message: "Skills added successfully.", skills: user.skills });
    } catch (error) {
      res
        .status(500)
        .json({ message: "An error occurred while adding skills" });
    }
  },
  ...
  deleteSkill: async (req, res) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ message: "An error occurred while deleting the skill" });
    }
  },
  ...
  addWorkHistory: async (req, res, next) => {
    ...
    try {
      ...
      res
        .status(201)
        .json({ message: "Work history added", workHistory: user.workHistory });
    } catch (error) {
  ...
  updateWorkHistory: async (req, res, next) => {
    ...
    try {
      ...
      const workHistoryIndex = user.workHistory.findIndex(
      ...
      res
        ...
        .json({
          ...
          workHistory: user.workHistory[workHistoryIndex],
        });
    } catch (error) {
  ...
  addEducationDetails: async (req, res, next) => {
    ...
    try {
      ...
      res
        .status(201)
        .json({ message: "Education added", education: user.education });
    } catch (error) {
      res
        .status(500)
        .json({ message: "Error adding education details", error });
    }
  },
  ...
  updateEducationDetails: async (req, res, next) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ message: "Error updating education details", error });
    }
  },
  ...
  deleteEducationDetails: async (req, res, next) => {
    ...
    try {
      ...
      res
        .status(500)
        .json({ message: "Error deleting education details", error });
    }
  },
